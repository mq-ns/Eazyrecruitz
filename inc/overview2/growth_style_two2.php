   <!-- growth-style-two -->
   <section page="inc/overview2/growth_style_two2.php" class="growth-style-two bg-color-2">
                            ...
                            <div class="content-box">
                                ...
                                <div class="inner-box">
                                    <div class="text">
                                        ...
                                        <p>Ever undertakes laborious physical exercise except to obtain some advantage from but who has any right to find fault.</p>
                                    </div>
