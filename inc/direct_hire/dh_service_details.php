<!-- service-details -->
<section apge="inc/direct_hire/dh_service_details.php" class="service-details">
            ...
            <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                <div class="service-details-content">
                    <div class="content-one">
                        <div class="sec-title">
                            <span class="top-title">Direct Hire</span>
                        ...
                        <div class="inner-box clearfix">
                            <div class="single-column">
                                <div class="content-box">
                                    ...
                                    <div class="link"><a href="temprory-staffing.php"><i
                                ...
                                <div class="overlay-box">
                                    ...
                                    <div class="link"><a href="temprory-staffing.php"><i
                                                class="flaticon-right-arrow"></i>More Details</a></div>
                                </div>
                            </div>
                            <div class="single-column">
                                <div class="content-box">
                                ...
                                <div class="col-lg-9 col-md-12 col-sm-12 content-column">
                                    <div class="tabs-content">
                                        <div class="tab active-tab" id="tab-1">
                                            <div class="inner-box">
                                                <figure class="image-box"><img src="assets/images/service/details-2.jpg"
                                                        alt=""></figure>
                                                <div class="text">
                                                    <h3>Short Term Hiring</h3>
                                                    <p>Many variations of passage of lorem Ipsum available but the
                                                        majority have suffered alterations in some form injected humour,
                                                        or randomised words slightly.</p>
                                                    <a href="temprory-staffing.php"><i
                                                            class="flaticon-right-arrow"></i>More Details</a>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="service-sidebar">
                    <div class="sidebar-widget categories-widget">
                        <ul class="categories-list clearfix">
                            ...
                            <li><a href="direct-hire.php" class="active">Direct Hire</a></li>
