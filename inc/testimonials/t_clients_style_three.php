        ...
        <!-- clients-style-three -->
        <section page="inc/testimonials/t_clients_style_three.php" class="clients-style-three">
            <div class="auto-container">
                <div class="video-content">
                    <div id="image_block_1">
                        <div class="image-box">
                            <div class="video-inner" style="background-image: url(assets/images/resource/video-bg-3.jpg);">
